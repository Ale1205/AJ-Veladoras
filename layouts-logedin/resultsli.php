...
<head>
    ...
    <title>AJ veladoras | Resultados</title>
</head>
<body>
    <?php
        include 'navli.php';
    ...
    <?php
        ...
        $search_consul = $_POST['db_search'];
        $consul = "SELECT * FROM productos WHERE item_name LIKE '%$search_consul%' OR item_odor LIKE '%$search_consul%' OR item_type LIKE '%$search_consul%'";
        $resul = mysqli_query($connection, $consul) or die ("Algo salio mal");
        echo "<h1 class=candle-type-tittle>Resultados para: ".$search_consul."</h1>";
